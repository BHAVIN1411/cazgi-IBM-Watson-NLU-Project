...
function getNLUInstance() {
    ...
    const naturalLanguageUnderstanding = new NaturalLanguageUnderstandingV1({
        ...
        authenticator: new IamAuthenticator ({
            apikey:'OUdVRhuRtQc7V-lCxMIAW3-hLmnruMXl5rfXonWT2dCC'
        }),
        serviceUrl:'https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/68fb5cf9-f4c8-4daf-9518-05c707f11e6f'
    });
